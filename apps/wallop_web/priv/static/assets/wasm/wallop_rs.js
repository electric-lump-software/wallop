...
export function compute_seed_drand_only_wasm(entry_hash, drand_randomness) {
    ...
    const ptr1 = passStringToWasm0(drand_randomness, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.compute_seed_drand_only_wasm(ptr0, len0, ptr1, len1);
    if (ret[2]) {
...
export function compute_seed_wasm(entry_hash, drand_randomness, weather_value) {
    ...
    const ptr1 = passStringToWasm0(drand_randomness, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(weather_value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.compute_seed_wasm(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function draw_wasm(entries_js, seed_js, count) {
    const ptr0 = passArray8ToWasm0(seed_js, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.draw_wasm(entries_js, ptr0, len0, count);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function entry_hash_wasm(entries_js) {
    const ret = wasm.entry_hash_wasm(entries_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function verify_wasm(entries_js, drand_randomness, weather_value, count, expected_results_js) {
    const ptr0 = passStringToWasm0(drand_randomness, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(weather_value) ? 0 : passStringToWasm0(weather_value, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_wasm(entries_js, ptr0, len0, ptr1, len1, count, expected_results_js);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
