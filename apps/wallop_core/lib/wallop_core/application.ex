defmodule WallopCore.Application do
  ...
  # Warn if a consuming app is using the default Oban prefix.
  # The wallop umbrella uses the default prefix; consuming apps must
  # use a different prefix to avoid competing for draw jobs.
